...
class ObsLinks(object):
        ...
        with open(fname,"r") as f:
            for line in f:
                if line and len(line) > 2 and not line.startswith("#"):
                    ...
                    self.links[(station_id,variable,vloc)] = (station_id,variable,path,selector,agency,unit,vdatum,tzone,voffset,vloc)
                    self.data2d[(station_id,variable)] = (station_id,variable,tzone,vdatum,voffset,agency,unit)
    ...
    def datum_adjust(self, station_id, variable):
